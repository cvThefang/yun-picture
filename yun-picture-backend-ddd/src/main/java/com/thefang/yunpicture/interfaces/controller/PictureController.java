...
import com.thefang.yunpicture.infrastructure.api.imagesearch.ImageSearchApiFacade;
import com.thefang.yunpicture.infrastructure.api.imagesearch.model.ImageSearchResult;
...
import com.thefang.yunpicture.interfaces.assembler.PictureAssembler;
...
import com.thefang.yunpicture.shared.auth.annotation.SaSpaceCheckPermission;
import com.thefang.yunpicture.shared.auth.model.SpaceUserPermissionConstant;
...
import com.thefang.yunpicture.interfaces.vo.picture.PictureTagCategory;
...
//    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<PictureVO> getPictureVOById(long id, HttpServletRequest request) {
        ...
        if (spaceId == null) {
            ...
            if (!loginUser.getId().equals(picture.getUserId()) && !loginUser.isAdmin()) {
